...
function _oscintegrator_synapsephaseshift(  wts::Wts,
                                            netparams::NetParams,
                                            runparams::RunParams,
                                            simvals::SimVals,
    ...
    synapseinput = synapseamplitude + I(t, synapseamplitude, runparams.omega_I_t, synapsephase) 
    ...
    kv1 = dt * dvdt(integratornode.v, netparams.g_L, netparams.E_L, 
                    ...
                    synapseinput, netparams.g_syn, wts.w_EE,
    ...
    if mod(a,runparams.downsamplespacing) == 0
        ...
        integratornode.s_vect[b] = synapseinput; 
